...
const resolvers = {
    ...
    Mutation: {
        ...
        followProfile(parent, {data: {followingProfileId}, where: {username: currentUsername}}, {dataSources}, info) {
            return dataSources.profilesAPI.followProfile(currentUsername, followingProfileId)
        },
        unfollowProfile(parent, {data: {followingProfileId}, where: {username: currentUsername}}, {dataSources}, info) {
            return dataSources.profilesAPI.unfollowProfile(currentUsername, followingProfileId)
        }
    }
}
